...
use libp2p::request_response::{self, cbor, Config, OutboundRequestId, ProtocolSupport};
...
pub struct NicknameBehaviour {
    ...
    pub request_response: cbor::Behaviour<NicknameRequest, NicknameResponse>,
}
    ...
    pub fn create_behaviour(
        ...
        let behaviour = NicknameBehaviour {
            ...
            request_response: cbor::Behaviour::new(
                [(
                    libp2p::StreamProtocol::new("/nickname/1.0.0"),
