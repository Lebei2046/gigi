...
fn group_and_sort_contacts(
    contacts: Vec<Contact>,
    search_term: String,
) -> Vec<(String, Vec<Contact>)> {
    ...
    let mut grouped: std::collections::HashMap<char, Vec<Contact>> =
                            ...
                            div { key: "{letter}", class: "mb-4",
                                ...
                                div { class: "bg-white rounded-xl shadow-sm overflow-hidden",
                                    for contact in group {
                                        div {
                                            key: "{contact.id}",
                                            class: "flex items-center px-4 py-3 border-b border-gray-100 last:border-b-0 hover:bg-gray-50 transition-colors cursor-pointer",
