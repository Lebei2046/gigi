...
use crate::features::chat::hooks::{use_chat_initialization, use_chat_event_listeners, use_chat_data_refresh, use_peer_actions, use_group_actions};
use crate::features::chat::components::{PeerChatCard, GroupChatCard};
...
pub fn Chat() -> Element {
    ...
    rsx! {
        div { 
            class: "flex flex-col h-full bg-gray-50",
            // Header
            div { 
                class: "bg-white border-b border-gray-200 px-4 py-4",
                h2 { 
            ...
            div { 
                ...
                div { 
                    ...
                    div { 
                        ...
                        span { 
                            class: "bg-blue-100 text-blue-600 text-xs font-medium px-2 py-1 rounded-full",
