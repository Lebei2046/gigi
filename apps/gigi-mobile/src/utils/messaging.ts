...
export class MessagingClient {
  ...
  static async sendMessageToNickname(nickname: string, message: string): Promise<string> {
  ...
  // Send group message
  static async sendGroupMessage(groupId: string, message: string): Promise<string> {
  ...
  static async requestFile(fileId: string, fromPeerId: string): Promise<string> {
    return invoke('messaging_request_file', { fileId, fromPeerId });
  }

  // Request/download file by nickname (preferred)
  static async requestFileFromNickname(nickname: string, shareCode: string): Promise<string> {
    return invoke('messaging_request_file_from_nickname', { nickname, shareCode });
  }
